...
procedure Parse is
   ...
   procedure Process_Lookups (Node : Turkixir_Node'Class);
   procedure Process_Node (Res : Turkixir_Node'Class);
   ...
   procedure Process_Lookups (Node : Turkixir_Node'Class) is
   begin
      for Lookup_Str of Args.Lookups.Get loop
         ...
         declare
            ...
            Lookup_Node : constant Turkixir_Node :=
   ...
   procedure Process_Node (Res : Turkixir_Node'Class) is
   begin
      if Is_Null (Res) then
         Put_Line ("<null node>");
         return;
   ...
   is
      ...
      procedure Check_Consistency
        (Node, Parent : Turkixir_Node);

      procedure Check_Consistency
        (Node, Parent : Turkixir_Node) is
      begin
