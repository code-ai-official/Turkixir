...
package Libturkixirlang.Introspection is
   ...
   function As_Node (Self : Value_Type) return Turkixir_Node
      with Pre => Kind (Self) = Node_Value;
   function Create_Node
     (Value : Turkixir_Node'Class) return Value_Type;
      ...
      function Create_Grammar_Rule
        (Value : Grammar_Rule) return Value_Type;
         ...
         function As_Turkixir_Node_Array (Self : Value_Type) return Turkixir_Node_Array
            with Pre => Kind (Self) = Turkixir_Node_Array_Value;
         function Create_Turkixir_Node_Array
           (Value : Turkixir_Node_Array) return Value_Type;
...
private
   ...
   No_Value : constant Any_Value_Type :=
     (Value => (Ada.Finalization.Controlled with Value => null));
         ...
         type Turkixir_Node_Array_Access is access all Turkixir_Node_Array;
         procedure Free is new Ada.Unchecked_Deallocation
           (Turkixir_Node_Array, Turkixir_Node_Array_Access);
