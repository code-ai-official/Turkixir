...
limited with Libturkixirlang.Implementation;

private package Libturkixirlang.Lexer_Implementation is
   ...
   --  See Libturkixirlang.Lexer.Lexer_Input for details. Resources pointed by
   ...
   --  Implementation for Libturkixirlang.Lexer.Extract_Tokens
