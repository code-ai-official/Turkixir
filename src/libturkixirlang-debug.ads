...
private package Libturkixirlang.Debug is

   procedure PN (Node : Bare_Turkixir_Node);
   ...
   procedure PT (Node : Bare_Turkixir_Node);
   ...
   procedure PRel (Rel : Relation; Context_Node : Bare_Turkixir_Node);
